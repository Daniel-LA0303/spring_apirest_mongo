        ...
        stage('Desplegar en EC2') {
            steps {
                withEnv(["PATH+SSH=C:\\Windows\\System32\\OpenSSH"]) {
                    ...
                    echo ===== REINICIANDO APLICACION EN EC2 =====
                    ssh -i "C:\\Users\\darkso\\.jenkins\\.ssh\\spring-jenkins-cd-pem.pem" ec2-user@100.24.25.195 "pkill -f 'java -jar /home/ec2-user/app.jar' || true && nohup java -jar /home/ec2-user/app.jar > /home/ec2-user/app.log 2>&1 &"
