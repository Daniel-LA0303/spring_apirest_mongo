package com.example.SB_apirest_mongo.controller;

import com.example.SB_apirest_mongo.model.User;
import com.example.SB_apirest_mongo.service.UserService;
...
public class UserController {
    ...
    @PutMapping("/users/{id}")
    public ResponseEntity<Map<String, Object>> updateUser(@PathVariable String id, @Valid @RequestBody User user, BindingResult bindingResult) {
        try {
